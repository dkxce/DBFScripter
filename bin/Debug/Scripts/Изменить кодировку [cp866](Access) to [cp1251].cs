...
namespace DBFScripting
{
	...
	{		
		...
		{
			L("Преобразование полей DBF из кодировки [cp866](DOS/Acccess) в [cp1251](Win)");
		}
		...
		public override Encoding FileReadEncoding { get { return System.Text.Encoding.GetEncoding(866); } } // Кодировка файла
